...
def add_letter_b(polygons, x, y, z, bogus):
  ...
  add_polygon(polygons, 18, 0, 0, 0, 97, 0, 18, 97, 0);
  # add_polygon(polygons, 18, 97, 0, 18, 0, 0, 45, 0, 0);
  # add_polygon(polygons, 45,0,0,45,97,0,63,97,0);
  # add_polygon(polygons, 45,0,0,45,97,0,33,40,0);
  # add_polygon(polygons, 28,60,0,23,79,0,41,79,0);
  # add_polygon(polygons, 28,60,0,41,79,0,38,60,0);
