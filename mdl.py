...
def p_command_letter(p):
  """command : LETTER NUMBER NUMBER NUMBER NUMBER
         | LETTER SYMBOL NUMBER NUMBER NUMBER NUMBER
         | LETTER NUMBER NUMBER NUMBER NUMBER SYMBOL
         | LETTER SYMBOL NUMBER NUMBER NUMBER NUMBER SYMBOL"""
